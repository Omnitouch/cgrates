...
echo "go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration $@"
go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration $@
results+=($?)
echo "go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration $@"
go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration $@
results+=($?)
...
results+=($?)
echo "go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline $@"
go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline $@
results+=($?)
else
# Internal
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*internal'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*internal
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*internal'
go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*internal
results+=($?)
...
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*internal'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*internal
results+=($?)
# SQL
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*mysql'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*mysql
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*mysql'
go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*mysql
results+=($?)
...
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*mysql'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*mysql
results+=($?)
# Mongo
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*mongo'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*mongo
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*mongo'
go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*mongo
results+=($?)
...
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*mongo'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*mongo
results+=($?)
# Postgres
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*postgres'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=integration -dbtype=*postgres
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*postgres'
go test github.com/Omnitouch/cgrates/apier/v2 -tags=integration -dbtype=*postgres
results+=($?)
...
results+=($?)
echo 'go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*postgres'
go test github.com/Omnitouch/cgrates/apier/v1 -tags=offline -dbtype=*postgres
results+=($?)
